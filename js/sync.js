...
(function () {
  ...
  // 午後II学習画面（骨子・執筆・振り返り）用のサブコレクション参照。
  // 骨子・論文は容量が大きいため users/{uid} 本体ドキュメントではなく
  // users/{uid}/pm2docs/{docId} に1テーマ1ドキュメントで保存する。
  // docId は themeKey ("<examId>#pm2#<no>") の "#" を "_" に置換したもの。
  function pm2DocRef(themeKey) {
