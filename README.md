...
ITストラテジスト試験（ST）の総合学習アプリです（午前Iは免除のため対象外）。
公開URL: https://tk67278-boop.github.io/st-kakomon/

モード構成:
- **午前II**: 過去問一問一答（16回・400問、解説付き、nw-siken.com風）
- **午後I / 午後II**: 過去問一覧（タイトル・業種/テーマタグ・IPA公式PDFリンク）＋演習記録＋タイマー
- **教科書**: 8章41節・約6万字の試験範囲テキスト（読了管理・節ごとの確認問題ジャンプ付き）
- **用語**: 用語辞典308語（解説・重要度★・登場した過去問への直接ジャンプ）
